...
def create_network_event_recorder(network: JavaHandle) -> JavaHandle: ...

def start_network_event_recorder(recorder: JavaHandle) -> None: ...

def stop_network_event_recorder(recorder: JavaHandle) -> None: ...

def clear_network_event_recorder(recorder: JavaHandle) -> None: ...

def get_network_event_count(recorder: JavaHandle) -> int: ...

def create_network_events_series_array(recorder: JavaHandle) -> SeriesArray: ...

def export_network_events_to_partial_ssh(recorder: JavaHandle, options: Dict[str, str]) -> str: ...

def export_network_events_to_cgmes_diff(recorder: JavaHandle, profile: str, options: Dict[str, str]) -> str: ...

def export_network_events_to_cgmes_diffs(recorder: JavaHandle, options: Dict[str, str]) -> Dict[str, str]: ...

def create_rdf_db_connection(url: str, options: Dict[str, str]) -> JavaHandle: ...

def close_rdf_db_connection(db: JavaHandle) -> None: ...

def get_rdf_db_scenarios(db: JavaHandle) -> List[str]: ...

def get_rdf_db_graphs(db: JavaHandle, scenario: str) -> SeriesArray: ...

def clear_rdf_db(db: JavaHandle, scenario: str) -> None: ...

def load_cgmes_to_rdf_db(db: JavaHandle, file: str, scenario: str, version: str, timestep: str, parameters: Dict[str, str], report_node: Optional[JavaHandle]) -> List[str]: ...

def load_cgmes_buffers_to_rdf_db(db: JavaHandle, buffers: List[memoryview], scenario: str, version: str, timestep: str, parameters: Dict[str, str], report_node: Optional[JavaHandle]) -> List[str]: ...

def load_network_from_rdf_db(db: JavaHandle, scenario: str, version: str, timestep: str, parameters: Dict[str, str], post_processors: List[str], report_node: Optional[JavaHandle], allow_variant_multi_thread_access: bool) -> JavaHandle: ...

def update_network_from_rdf_db(network: JavaHandle, db: JavaHandle, scenario: str, version: str, timestep: str, subsets: List[str], options: Dict[str, str], parameters: Dict[str, str], report_node: Optional[JavaHandle]) -> JavaHandle: ...

def get_rdf_db_update_info(outcome: JavaHandle) -> Dict[str, str]: ...

def get_rdf_db_update_network(outcome: JavaHandle) -> JavaHandle: ...

def get_rdf_db_scenario_table(db: JavaHandle) -> SeriesArray: ...

def get_rdf_db_snapshots(db: JavaHandle, scenario: str) -> SeriesArray: ...

def get_rdf_db_versions(db: JavaHandle, scenario: str, timestep: str) -> SeriesArray: ...

def get_rdf_db_timesteps(db: JavaHandle, scenario: str) -> SeriesArray: ...

def get_rdf_db_models(db: JavaHandle, scenario: str) -> SeriesArray: ...

def is_rdf_db_versioned(db: JavaHandle, scenario: str) -> bool: ...

def create_rdf_db_checkpoint(db: JavaHandle, scenario: str, version: str, timestep: str) -> str: ...

def export_network_events_to_rdf_db(recorder: JavaHandle, db: JavaHandle, scenario: str, version: str, timestep: str, options: Dict[str, str]) -> List[str]: ...

def get_network_rdf_db_identity(network: JavaHandle, db: Optional[JavaHandle], scenario: str, variant: str) -> Dict[str, str]: ...

def load_network_variants_from_rdf_db(db: JavaHandle, scenario: str, variant_ids: List[str], versions: List[str], timesteps: List[str], parameters: Dict[str, str], report_node: Optional[JavaHandle], allow_variant_multi_thread_access: bool) -> JavaHandle: ...

def get_network_rdf_db_variants(network: JavaHandle) -> SeriesArray: ...

def export_network_events_to_rdf_db_per_variant(recorder: JavaHandle, db: JavaHandle, scenario: str, version: str, options: Dict[str, str]) -> SeriesArray: ...
