...
from typing import ClassVar, Dict, Iterator, List, Sequence, Optional, Union, Any, Tuple
...
def get_ybus_matrix(network: JavaHandle, parameters: LoadFlowParameters, provider: str) -> Matrix: ...
def get_ybus_csr_matrix(network: JavaHandle, parameters: LoadFlowParameters, provider: str) -> Tuple[Any, Any, Any, Tuple[int, int]]: ...
def get_ybus_labels(network: JavaHandle, parameters: LoadFlowParameters, provider: str) -> Tuple[List[str], List[str]]: ...
